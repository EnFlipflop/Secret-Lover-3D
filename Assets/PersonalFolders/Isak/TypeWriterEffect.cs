...
namespace Isak.Typography.Typewriter
{
    ...
    public class TypewriterEffect : MonoBehaviour
    {
        ...
        public static event Action<TMP_Text> CompleteTextRevealed;
        ...
        // has been pressed in this system. Go watch Piti's video on the different ways of utilizing the new input system: https://www.youtube.com/watch?v=Wo6TarvTL5Q
         ...
         {
             Debug.Log("Typewriter triggered");
        ...
        private IEnumerator Typewriter()
        {
            ...
            while (_currentVisibleCharacterIndex < textInfo.characterCount + 1)
            {
                ...
                if (_currentVisibleCharacterIndex >= lastCharacterIndex)
                {
                    ...
                    CompleteTextRevealed?.Invoke(_textBox);
